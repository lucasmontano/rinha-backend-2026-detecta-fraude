...
RUN apt-get update && apt-get install -y --no-install-recommends \
        ca-certificates curl gcc libc6-dev gcc-x86-64-linux-gnu libc6-dev-amd64-cross \
